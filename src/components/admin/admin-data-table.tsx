...
import { MoreHorizontal, Edit, Shield, Ban, Trash2, ChevronLeft, ChevronRight, Unlock, ShieldCheck } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
        ...
        <table className="w-full">
          <thead className="bg-card">
            <tr className="border-b border-border">
              <th className="p-4 text-sm text-left font-medium text-gray-300">Name</th>
              <th className="p-4 text-sm text-left font-medium text-gray-300">Email</th>
              <th className="p-4 text-sm text-left font-medium text-gray-300">Role</th>
              <th className="p-4 text-sm text-left font-medium text-gray-300">Permissions</th>
              <th className="p-4 text-sm text-left font-medium text-gray-300">Status</th>
              <th className="p-4 text-sm text-left font-medium text-gray-300">Last Login</th>
              <th className="p-4 text-sm text-left font-medium text-gray-300">Actions</th>
            </tr>
          </thead>
          <tbody>
            ...
            {data.length === 0 ? (
              ...
              <tr key={admin.id} className="border-b border-border hover:bg-gray-750 transition-colors">
                ...
                <td className="p-4 text-sm text-gray-300">{admin.lastLogin}</td>
                <td className="p-4">
                  <DropdownMenu>
